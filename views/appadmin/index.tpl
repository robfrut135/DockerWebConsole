	...
	<div>
		<form method="POST" class="form-inline">
			<div class="form-group">
						...
						<select name="comparefield" class="form-control">
						...
						<select name="compareop" class="form-control">
						...
						<input name="compareval" class="form-control" value="0" title="All search terms are compared as text strings. 'Reg date' has a date format of yyyy-mm-dd." />
				</div>
